...
namespace ToDoList.Tests
{
  ...
  public class CategoryTest : IDisposable
  {
    ...
    //   Category testCategory = new Category("Household chores");
    //   testCategory.Save();
    //   Item testItem1 = new Item("Climb the walls");
    //   testItem1.Save();
    //   Item testItem2 = new Item("Tear out hair");
    //   testItem2.Save();
    //
    //   //Act
    ...
    {
      //Arrange
      string description = "Climb the walls.";
      ...
      Console.WriteLine("Result length: " + result.Count + "; newList length: " + newList.Count);
